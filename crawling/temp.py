...
jongmok_code = ExcelRead("C:/study/quant_invest/crawling/sangjang_jongmokCode.xlsx")
jongga_data = {}
...
fn1 = 'C:/study/quant_invest/crawling/' + str(nds) + '/dailyUpdateData.json'
# fn2 = './data/' + str(nds) + '/no_jongga.json'

dn = 'C:/study/quant_invest/crawling/' + str(nds)
if os.path.isdir(dn):
    shutil.rmtree(dn)
os.mkdir(dn)
